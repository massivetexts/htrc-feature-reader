...
def retrieve_parser(id, format, id_resolver, compression, dir=None,
    ...
    if file_handler:
        ...
        raise NotImplementedError("Must pass a format. Currently 'json', "
                                  "'feather', and 'parquet' are supported.")
...
class Volume(object):
    ...
    def raw_tokenlist(self):
        if self.parser.format == "feather":
            return self.parser._make_tokencount_df(indexed = False)
